...
public class JobController {
    ...
    @Operation(summary = "Criar vaga", description = "Função responsável por criar novas vagas")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Vaga criada com sucesso", content = @Content(schema = @Schema(implementation = JobEntity.class))),
    })
